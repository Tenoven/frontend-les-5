...
// opdracht 3
const secundaryUserInput = prompt("Je koos " + userInput + " Over welke functie wil je meer weten? Voer een getal tussen 0 en 3 in.\n" +
...
console.log(secundaryUserInput);

switch (secundaryUserInput) {
    case '0':
